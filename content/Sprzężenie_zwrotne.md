...
sprzężeniem, niektóre alikwoty<!-- link nie odnosił się do niczego: 'Sprzężenie zwrotne' (PosixPath('Sprzężenie_zwrotne.md')) links to 'alikwot' (PosixPath('/no/path/exists')) and that does not exist --> stają się
