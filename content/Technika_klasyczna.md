...
Tarregę<!-- link nie odnosił się do niczego: 'Technika klasyczna' ('content/Technika_klasyczna.md') links to 'Francisco_Tarrega' ('content/Francisco_Tarrega.md') and that does not exist -->, działającego pod koniec XIX w.
...
muzyką jazzową są: Charlie Byrd<!-- link nie odnosił się do niczego: 'Technika klasyczna' ('content/Technika_klasyczna.md') links to 'Charlie_Byrd' ('content/Charlie_Byrd.md') and that does not exist --> i Laurindo
Almeida<!-- link nie odnosił się do niczego: 'Technika klasyczna' ('content/Technika_klasyczna.md') links to 'Laurindo_Almeida' ('content/Laurindo_Almeida.md') and that does not exist -->. Wyjątkiem jest czarny Amerykanin
Earl Klugh<!-- link nie odnosił się do niczego: 'Technika klasyczna' ('content/Technika_klasyczna.md') links to 'Earl_Klugh' ('content/Earl_Klugh.md') and that does not exist -->, który posługując się klasyczną
...
w jazzie<!-- link nie odnosił się do niczego: 'Technika klasyczna' ('content/Technika_klasyczna.md') links to 'jazz' ('content/jazz.md') and that does not exist -->. Naturalnie, zdarzają się indywidualności,
