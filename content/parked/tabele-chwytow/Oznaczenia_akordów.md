...
jazzowego<!-- link nie odnosił się do niczego: 'Oznaczenia akordów' ('content/parked/tabele-chwytow/Oznaczenia_akordów.md') links to 'blues_jazzowy' ('content/parked/tabele-chwytow/blues_jazzowy.md') and that does not exist -->.
...
II-V-I (czyt. *dwa pięć jeden<!-- link nie odnosił się do niczego: 'Oznaczenia akordów' ('content/parked/tabele-chwytow/Oznaczenia_akordów.md') links to 'dwa_pięć_jeden' ('content/parked/tabele-chwytow/dwa_pięć_jeden.md') and that does not exist -->*). W tonacji
...
| mol siedem pięć minus | Cm7♭5<!-- link nie odnosił się do niczego: 'Oznaczenia akordów' ('content/parked/tabele-chwytow/Oznaczenia_akordów.md') links to 'Cm7♭5' ('content/parked/tabele-chwytow/Cm7♭5.md') and that does not exist -->, C-<sup>7♭5</sup>, C⊘ |
...
D7♯9<!-- link nie odnosił się do niczego: 'Oznaczenia akordów' ('content/parked/tabele-chwytow/Oznaczenia_akordów.md') links to 'D7♯9' ('content/parked/tabele-chwytow/D7♯9.md') and that does not exist -->. Składniki obniżone o pół tonu oznacza się ♭
...
harmoniczna<!-- link nie odnosił się do niczego: 'Oznaczenia akordów' ('content/parked/tabele-chwytow/Oznaczenia_akordów.md') links to 'interpretacja_harmoniczna' ('content/parked/tabele-chwytow/interpretacja_harmoniczna.md') and that does not exist -->
