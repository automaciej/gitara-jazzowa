...
Druga odmiana wibracji - bluesową<!-- link nie odnosił się do niczego: 'Wibracja' (PosixPath('Wibracja.md')) links to 'blues' (PosixPath('/no/path/exists')) and that does not exist -->, realizowana jest
