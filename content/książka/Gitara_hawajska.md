...
akordzie durowym e, cis, a, e, A, E (A<!-- link nie odnosił się do niczego: 'Gitara hawajska' ('content/książka/Gitara_hawajska.md') links to 'A' ('content/książka/A.md') and that does not exist -->-dur). Dla
...
Hawajska, gitara<!-- link nie odnosił się do niczego: 'Gitara hawajska' ('content/książka/Gitara_hawajska.md') links to 'kategoria:rodzaje_gitar' ('content/książka/kategoria:rodzaje_gitar.md') and that does not exist -->