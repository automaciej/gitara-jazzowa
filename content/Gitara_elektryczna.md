...
mikrostrojniki<!-- link nie odnosił się do niczego: 'Gitara elektryczna' (PosixPath('Gitara_elektryczna.md')) links to 'mikrostrojnik' (PosixPath('/no/path/exists')) and that does not exist -->, regulację
menzury<!-- link nie odnosił się do niczego: 'Gitara elektryczna' (PosixPath('Gitara_elektryczna.md')) links to 'menzura' (PosixPath('/no/path/exists')) and that does not exist --> i mini-imadełko do zamocowania struny.
...
potencjometry<!-- link nie odnosił się do niczego: 'Gitara elektryczna' (PosixPath('Gitara_elektryczna.md')) links to 'potencjometr' (PosixPath('/no/path/exists')) and that does not exist --> siły głosu, barwy tonu,
...
łatwiej dźwięk przesterować<!-- link nie odnosił się do niczego: 'Gitara elektryczna' (PosixPath('Gitara_elektryczna.md')) links to 'przesterowanie' (PosixPath('/no/path/exists')) and that does not exist --> i grać
...
flanger<!-- link nie odnosił się do niczego: 'Gitara elektryczna' (PosixPath('Gitara_elektryczna.md')) links to 'flanger' (PosixPath('/no/path/exists')) and that does not exist -->, [chorus]({{< relref "Chorus.md" >}}) itp.

Elektryczna, gitara<!-- link nie odnosił się do niczego: 'Gitara elektryczna' (PosixPath('Gitara_elektryczna.md')) links to 'kategoria:rodzaje_gitar' (PosixPath('/no/path/exists')) and that does not exist -->
