...
gitarę elektryczną, gitarzysta grający bebop<!-- link nie odnosił się do niczego: 'Wzmacniacz' (PosixPath('Wzmacniacz.md')) links to 'bebop' (PosixPath('/invalid/path')) and that does not exist --> - kupi
sobie [gitarę
...
mocny pokrowiec<!-- link nie odnosił się do niczego: 'Wzmacniacz' (PosixPath('Wzmacniacz.md')) links to 'pokrowiec_na_wzmacniacz' (PosixPath('/invalid/path')) and that does not exist --> wykonany z
...
głośników. Przy graniu mainstreamowym<!-- link nie odnosił się do niczego: 'Wzmacniacz' (PosixPath('Wzmacniacz.md')) links to 'mainstream' (PosixPath('/invalid/path')) and that does not exist --> dobrze
