...
znaki określają bliżej jego składniki<!-- link nie odnosił się do niczego: 'Notacja harmoniczna' (PosixPath('Notacja_harmoniczna.md')) links to 'składniki_akordu' (PosixPath('/no/path/exists')) and that does not exist -->.
...
interwałów<!-- link nie odnosił się do niczego: 'Notacja harmoniczna' (PosixPath('Notacja_harmoniczna.md')) links to 'interwał' (PosixPath('/no/path/exists')) and that does not exist --> (nie tylko w szeregu tercjowym),
praktycznie za pomocą tych oznaczeń można określić każdy
akord<!-- link nie odnosił się do niczego: 'Notacja harmoniczna' (PosixPath('Notacja_harmoniczna.md')) links to 'akord' (PosixPath('/no/path/exists')) and that does not exist -->.
...
Należy zwrócić uwagę, że w odróżnieniu od nony<!-- link nie odnosił się do niczego: 'Notacja harmoniczna' (PosixPath('Notacja_harmoniczna.md')) links to 'nona' (PosixPath('/no/path/exists')) and that does not exist -->,
