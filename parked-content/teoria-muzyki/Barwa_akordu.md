...
mollowy<!-- link nie odnosił się do niczego: 'Barwa akordu' ('content/parked/teoria-muzyki/Barwa_akordu.md') links to 'akord_mollowy' ('content/parked/teoria-muzyki/akord_mollowy.md') and that does not exist --> od
durowego<!-- link nie odnosił się do niczego: 'Barwa akordu' ('content/parked/teoria-muzyki/Barwa_akordu.md') links to 'akord_durowy' ('content/parked/teoria-muzyki/akord_durowy.md') and that does not exist -->, nawet jeżeli nie wiemy dokładnie,
...
słuch absolutny<!-- link nie odnosił się do niczego: 'Barwa akordu' ('content/parked/teoria-muzyki/Barwa_akordu.md') links to 'słuch_absolutny' ('content/parked/teoria-muzyki/słuch_absolutny.md') and that does not exist -->, który polega na
...
kwinta<!-- link nie odnosił się do niczego: 'Barwa akordu' ('content/parked/teoria-muzyki/Barwa_akordu.md') links to 'kwinta' ('content/parked/teoria-muzyki/kwinta.md') and that does not exist -->, jeszcze inną nona
mała<!-- link nie odnosił się do niczego: 'Barwa akordu' ('content/parked/teoria-muzyki/Barwa_akordu.md') links to 'nona_mała' ('content/parked/teoria-muzyki/nona_mała.md') and that does not exist -->. W momencie kiedy brzmi (wybrzmiewa) akord
mamy<!-- link nie odnosił się do niczego: 'Barwa akordu' ('content/parked/teoria-muzyki/Barwa_akordu.md') links to 'mamy' ('content/parked/teoria-muzyki/mamy.md') and that does not exist --> do czynienia ze współbrzmieniem wszystkich
...
Powiedzmy, że gramy C<!-- link nie odnosił się do niczego: 'Barwa akordu' ('content/parked/teoria-muzyki/Barwa_akordu.md') links to 'C' ('content/parked/teoria-muzyki/C.md') and that does not exist -->-dur w postaci zasadniczej, czyli
...
Weźmy inny [akord]({{< relref "Akord.md" >}}), na przykład G9<!-- link nie odnosił się do niczego: 'Barwa akordu' ('content/parked/teoria-muzyki/Barwa_akordu.md') links to 'G9' ('content/parked/teoria-muzyki/G9.md') and that does not exist -->.
...
tercja wielka. Przykładowy układ akordu Cmaj96<!-- link nie odnosił się do niczego: 'Barwa akordu' ('content/parked/teoria-muzyki/Barwa_akordu.md') links to 'Cmaj96' ('content/parked/teoria-muzyki/Cmaj96.md') and that does not exist -->:
