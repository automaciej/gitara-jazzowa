...
chromatycznych<!-- link nie odnosił się do niczego: 'Częstotliwości dźwięków' ('content/parked/teoria-muzyki/Częstotliwości_dźwięków.md') links to 'Znak_chromatyczny' ('content/parked/teoria-muzyki/Znak_chromatyczny.md') and that does not exist -->.
